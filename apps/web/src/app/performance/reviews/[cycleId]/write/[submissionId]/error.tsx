...
export default function WriteReviewError({ error, reset }: WriteReviewErrorProps) {
  return (
    <main className="min-h-screen bg-slate-50 p-6 text-slate-900">
      <div className="mx-auto w-full max-w-2xl rounded-xl border border-rose-200 bg-white p-8 shadow-sm">
        <h1 className="text-2xl font-semibold text-rose-900">Unable to load review</h1>
