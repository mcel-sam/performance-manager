...
export default async function AdminSuccessionPositionDetailPage({
  params,
  searchParams,
}: {
  ...
  return (
    <SuccessionPositionDetailView
      ...
      detail={detail}
      formOptions={options}
      detailPath={`/admin/talent/succession/positions/${positionId}`}
      overviewHref="/admin/talent/succession"
